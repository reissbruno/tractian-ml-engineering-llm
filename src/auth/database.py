...
# Use environment variable or default to db_data directory for Docker persistence
DB_DIR = os.getenv("DB_DIR", "db_data")
os.makedirs(DB_DIR, exist_ok=True)
DATABASE_FILE = os.path.join(DB_DIR, "tractian.db")
