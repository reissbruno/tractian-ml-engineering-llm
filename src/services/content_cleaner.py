...
def clean_markdown_content(markdown_text: str) -> str:
    ...
    in_table_index = False  # To detect indices in table format
    ...
    for i, line in enumerate(lines):
        ...
        # Detect index tables (start with | and have dotted numbers)
...
def split_by_pages(markdown_text: str) -> list[tuple[int, str]]:
    ...
    # If no pages were detected, treat all content as page 1
