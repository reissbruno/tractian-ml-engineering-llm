...
Fast and efficient PDF → Markdown conversion.
- Fast processing (no heavy ML models)
- Structured output with intelligent heuristics
- Ideal for all types of PDF documents
"""
