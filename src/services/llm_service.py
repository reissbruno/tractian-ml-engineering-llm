...
class LLMService:
    ...
    def _build_messages(
        ...
        system_prompt = (
            ...
            "Answer questions based only on the provided context and images. "
            "\n\nIMPORTANT INSTRUCTIONS ABOUT IMAGES:\n"
            "- Focus ONLY on technical images: diagrams, schematics, charts, graphs, technical drawings, tables\n"
            "- IGNORE decorative images: logos, banners, backgrounds, dividers, icons, decorative borders\n"
            "- IGNORE marketing images: product photos, promotional images, company branding\n"
            "- If an image does not contain relevant technical information, do not mention it\n"
            "- Only reference images that directly help answer the question\n\n"
            "If the answer is not in the context or images, say so clearly. "
            "Be precise, objective, and cite specific parts of the context and relevant technical images when possible."
        )
